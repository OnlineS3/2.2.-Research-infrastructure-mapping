...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/add_non_esfri.css" type="text/css">
    ...
    <body>
        <div id='mainpage' class='site'>
            ...
            <div class='site-content'>
                <header id='appl-title' class='appl-title'>
                    <h2>Research Infrastructure Insertion Form</h2>
                </header>
                <article id='contentmain'>
                  <?php include 'php/forms/add_non_esfri.php'?>
                </article>
        ...
        <script type="text/javascript" src="js/riFormTutorialPopupController.js"></script> <!-- load our javascript file -->
